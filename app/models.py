...
class Place(Base):
    ...
    route_role: Mapped[str] = mapped_column(String(50), default="passed")
    ...
    gis_decision: Mapped[str | None] = mapped_column(String(30), nullable=True)
    record_level: Mapped[str | None] = mapped_column(String(40), nullable=True)
    travel_status: Mapped[str | None] = mapped_column(String(40), nullable=True)
    location_status: Mapped[str | None] = mapped_column(String(40), nullable=True)
    alias_relation: Mapped[str | None] = mapped_column(Text, nullable=True)
    decision_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
    previous_route_place: Mapped[str | None] = mapped_column(String(255), nullable=True)
    next_route_place: Mapped[str | None] = mapped_column(String(255), nullable=True)
    adjacency_type: Mapped[str | None] = mapped_column(String(40), nullable=True)
    ...
    coordinate_selected: Mapped[bool] = mapped_column(Boolean, default=False)
